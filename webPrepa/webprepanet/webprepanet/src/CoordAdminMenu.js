                        ...
                        <Card className="cards-size">
                            <Card.Link href="/tablaAlumnosA" className="link-format">
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                        Selecciona un taller para revisar todos los alumnos
                                        que han solicitado inscripcion para un grupo.
                                    </Card.Text>
                                </Card.Body>
                            </Card.Link>
                        </Card>
                        ...
                        <Card className="cards-size">
                            <Card.Link href="/" className="link-format">
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                        Observa una tabla con la informacion de todos los
                                        alumnos con sus estatus de inscripcion. Se puede filtrar
                                        la tabla con criterios.
                                    </Card.Text>
                                </Card.Body>
                            </Card.Link>
                        </Card>
